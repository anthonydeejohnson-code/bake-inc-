...
var trashpile = instance_nearest(x, y, o_spillage);
...
if (player1_in_circle)
{
    ...
    if (!player1_mop && (keyboard_check_pressed(ord("A")) || keyboard_check_pressed(ord("D"))))
    {
        player1_mop = true;
        player1_score  = 0;
...
if (player2_in_circle)
{
    ...
    if (!player2_mop&& (keyboard_check_pressed(vk_left) || keyboard_check_pressed(vk_right)))
    {
        player2_mop = true;
        player2_score  = 0;
